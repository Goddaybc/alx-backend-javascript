...
OBOBOB  information both about supported versions of Node.js and supported Linux
  distributions. To learn more about usage, see the repository:
OBOBOB    ${bold}https://github.com/nodesource/distributions${normal}
"
OBOBOB        echo
...
OBOBOBcheck_alt "Linux Mint"     "sarah"           "Ubuntu"        "xenial"
check_alt "Linux Mint"     "serena"          "Ubuntu"        "xenial"
OBOBOBcheck_alt "Linux Mint"     "sonya"           "Ubuntu"        "xenial"
check_alt "Linux Mint"     "sylvia"          "Ubuntu"        "xenial"
check_alt "Linux Mint"     "tara"            "Ubuntu"        "bionic"
OBOBOBcheck_alt "Linux Mint"     "tessa"           "Ubuntu"        "bionic"
